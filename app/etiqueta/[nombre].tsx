...
import { Product, searchProductsByLabel, } from "../../src/services/products.services";
...
export default function EtiquetaScreen() {
    ...
    useEffect(() => {
      async function cargarProductos() {
        try {
          const respuesta = await searchProductsByLabel(String(nombre), 1);
          console.log("RESPUESTA LABEL:", respuesta);
    ...
    async function cargarMas() {
      ...
      try {
        const respuesta = await searchProductsByLabel(
          String(nombre),
          page
        );
